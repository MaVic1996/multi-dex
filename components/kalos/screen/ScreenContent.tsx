import styles from "../../../styles/components/kalos/screen/ScreenContent.module.css";
      ...
      {!!pokedexData &&
        pokedexData.map((data: number | string, idx: number) => (
          <Box
            ...
            idx={idx + 1}
            pokeNum={data}
            onClick={() => obtainPokemonData(data)}
          ></Box>
        ))}

      <PokemonInfo
        pokemonIdx={pokedexData.indexOf(pokemonInfo?.id.toString()) + 1}
